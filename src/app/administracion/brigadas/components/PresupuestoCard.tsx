  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem", marginTop: "1rem" }}>
        ...
        {disponible < 0 && (
          <p style={{ fontSize: "1.2rem", color: "var(--danger)", marginTop: "0.4rem" }}>
            ⚠️ <strong>Alerta:</strong> El presupuesto ejecutado ha sobrepasado el límite inicial estimado por {formatCurrency(Math.abs(disponible))}.
          </p>
        )}
      </div>
    </div>
