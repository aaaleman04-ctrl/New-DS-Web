...
export async function AdminStats() {
  ...
  return (
    <>
      <div className={styles.statCard} style={{ borderTop: "4px solid var(--primaryColor)" }}>
        <div className={styles.statHeader}>
          <h3>Voluntarios Totales</h3>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="var(--primaryColor)" style={{ width: "2.2rem", height: "2.2rem" }}>
      ...
      <div className={styles.statCard} style={{ borderTop: "4px solid var(--accentColor)" }}>
        <div className={styles.statHeader}>
          <h3>Medicamentos</h3>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="var(--accentColor)" style={{ width: "2.2rem", height: "2.2rem" }}>
      ...
      <div className={styles.statCard} style={{ borderTop: "4px solid var(--primaryDark)" }}>
        <div className={styles.statHeader}>
          <h3>Pacientes Atendidos</h3>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="var(--primaryDark)" style={{ width: "2.2rem", height: "2.2rem" }}>
