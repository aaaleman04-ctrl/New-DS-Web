...
*Llevando atención médica y odontológica esencial a las comunidades de Honduras que más lo necesitan, una sonrisa a la vez.*
...
- **Estilos**: Vanilla CSS Modules (`.module.css`), priorizando un diseño limpio, ligero y completamente *Responsive*.
...
- **Capa de Servicios (Service Layer)**: Todas las consultas a base de datos y almacenamiento están desacopladas de la Interfaz de Usuario (UI) dentro de `src/lib/db` y `src/lib/storage`, utilizando un patrón *Singleton* para el cliente de Supabase.
